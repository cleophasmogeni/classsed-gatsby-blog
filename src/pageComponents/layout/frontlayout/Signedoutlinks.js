...
class Signedoutlinks extends React.Component{
  ...
  handleLoginWithGoogle=(props)=>{
    return this.props.signInGoogle();    
  }
              ...
              <div id="navBar" className="collapse navbar-collapse u-header__navbar-collapse py-0">
                <ul className="navbar-nav u-header__navbar-nav">
                  ...
                  <li className="nav-item hs-has-mega-menu u-header__nav-item"
                      ...
                      data-animation-out="fadeOut"
                      data-position="right">
                    <NavLink to ="/" id="PagesMegaMenu" className="nav-link u-header__nav-link" 
                       aria-haspopup="true"
                       aria-expanded="false">
                       Samples
                      {/* <span className="fa fa-angle-down u-header__nav-link-icon"></span> */}
                  ...
                  <li className="nav-item hs-has-sub-menu u-header__nav-item"
                        ...
                        data-animation-in="fadeInUp"
                        data-animation-out="fadeOut">
                        <NavLink to ="/" id="docsMegaMenu" className="nav-link u-header__nav-link"
                        aria-haspopup="true"
                        aria-expanded="false"
                  ...
                  <li className="nav-item u-header__nav-item-btn">
                    <NavLink to ="/login" className="btn btn-sm btn-primary" role="button"
...
const mapDispatchToProps = (dispatch) =>{
    return{
      ...
      signInEmail: (data) => dispatch(signInEmail(data))
    }
